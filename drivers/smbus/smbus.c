 ...
 *
 *  @note Uses T1 (same as UART uses) timer to generate
 *        the appropriate clock source. This way only requires 1 timer
 *        peripheral for these two interfaces.
 *        It gives approx. 77 kHz SMBus speed
 ******************************************************************************/
