...
#define COMM_IF_UART_RX_BUFFER  3000u //Tim: Maximum data legth is 150, I double it for save.
#endif

/*! UART TX Buffer size */
#ifndef COMM_IF_UART_TX_BUFFER
#define COMM_IF_UART_TX_BUFFER  300u //Tim: Maximum data legth is 150, I double it for save.
#endif
...
extern SEGMENT_VARIABLE(lUartInternal, tUartData, SEG_XDATA);
