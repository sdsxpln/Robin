...
#define B_P1_LED   4u
#define M_P1_LED   (1 << B_P1_LED )
SBIT(LED,  SFR_P1, B_P1_LED);
...
//------------------------------------------------------------------------------------------------
// C8051F9xx Hardware bit definitions (using compiler_def.h macros)
//------------------------------------------------------------------------------------------------
